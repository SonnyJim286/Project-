...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Notice.setText(_translate("MainWindow", "Please enter right subject name.(Your input should only be letter -c-)"))
    ...
    def GoBack(self):
        ...
        self.GBui = Screen4.Ui_AddNewSubScreen()
        self.GBui.setupUi(self.GB)
        self.GB.show()
        self.GB.setWindowTitle("Add New Subject")
        self.CloseWindow()
